...
MainWindow::MainWindow(QWidget *parent)
    ...
    connect(m_hotkeyHandler, &HotkeyHandler::hotKeyPressed,
...
bool MainWindow::isAutoStartEnabled() {
    ...
    QString regKey = QString("HKEY_CURRENT_USER\\Software\\Microsoft\\Windows\\CurrentVersion\\Run\\%1").arg(appName);
